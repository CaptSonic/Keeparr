 ...
 * and returned quietly. Anything else is a real failure: it's logged to BOTH the
 * container stdout (`docker logs`) and the app log (Settings → Logs) so it's
 * actually diagnosable, then returned as a 500.
 *
